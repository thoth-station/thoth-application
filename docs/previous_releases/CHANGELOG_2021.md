...
- Fixing mistakes, testing pre-commit _I wanted to setup pre-commit and update my patch from my local system to see if I could fix the error message._ Then I found some errors in my file from my last edit, which was great! Real fixes! _Then I learned how pre-commit works, as it caught my mistakes until I fixed them all :)_ Then I copied my changes over to my fork (quaid/thoth-application) * Now I am committing them to my fork in hopes I can go to the web UI to updated the pull request ( <https://github.com/thoth-station/thoth-application/pull/1611> )
